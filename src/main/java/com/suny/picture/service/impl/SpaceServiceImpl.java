...
import com.suny.picture.manager.sharding.DynamicShardingManager;
...
import com.suny.picture.model.enums.SpaceRoleEnum;
import com.suny.picture.model.enums.SpaceTypeEnum;
...
import com.suny.picture.service.SpaceUserService;
    ...
    public long addSpace(SpaceAddRequest spaceAddRequest, User loginUser) {
        ...
        synchronized (lock) {
            Long newSpaceId = transactionTemplate.execute(status -> {
                ...
                // 以后空间，抛出异常
                if (exists) {
                    throw new BusinessException(ErrorCode.OPERATION_ERROR, "每个用户每类空间只能拥有一个");
                }
                //创建空间
...
//                dynamicShardingManager.createSpacePictureTable(space);
    ...
    public void validSpace(Space space, boolean add) {
        ...
        ThrowUtils.throwIf(enumByValue1 == null, ErrorCode.PARAMS_ERROR, "空间类型错误");
