...
/** 管理员 删除用户信息 POST /api/user/delete */
...
/** 用户编辑信息 POST /api/user/edit */
export async function userEditInfoUsingPost(
...
/** 管理员 根据 id 获取用户信息 GET /api/user/get */
...
/** 根据 id 获取用户脱敏信息 GET /api/user/get/vo */
...
/** 管理员 分页获取用户信息 POST /api/user/list/page/vo */
...
/** 用户兑换vip POST /api/user/vip */
export async function userVipUsingPost(body: API.UserVipRequest, options?: { [key: string]: any }) {
